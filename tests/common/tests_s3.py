...
class TestS3BucketConnectorMethods(unittest.TestCase):
    ...
    def test_list_files_in_prefix_ok(self):
        """
        Tests the list_files_in_prefix_method for getting 
        2 file keys as list on the mocked s3 bucket
        """
        # Expected results
        prefix_exp = 'prefix/'
    ...
    def test_list_files_in_prefix_wrong_prefix(self):
        """
        Tests the list_files_in_prefix method in case of a wrong or not exixting prefix
        """
        # Expected results
